...
Namespace SelectingPropertiesToSerialize
    ...
    Public Partial Class Window1
        ...
        Private Sub gridControl1_Loaded(ByVal sender As Object, ByVal e As RoutedEventArgs)
            Me.gridControl1.ItemsSource = IssueList.GetData()
            For Each column As GridColumn In Me.gridControl1.Columns
        ...
        Private Sub column_AllowProperty(ByVal sender As Object, ByVal e As AllowPropertyEventArgs)
            e.Allow = e.DependencyProperty Is BaseColumn.ActualWidthProperty OrElse e.DependencyProperty Is ColumnBase.FieldNameProperty OrElse e.DependencyProperty Is BaseColumn.VisibleProperty
        End Sub
        ...
        Private Sub btnRestoreLayout_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
            Me.gridControl1.RestoreLayoutFromXml("layout.xml")
        End Sub

        Private Sub btnSaveLayout_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
            Me.gridControl1.SaveLayoutToXml("layout.xml")
        End Sub
    End Class
End Namespace
